...
public class DeviceManagementController implements Initializable {
    ...
    @FXML
    void contentHandled(ActionEvent event){
        DeviceTreeViewController treeController = (DeviceTreeViewController) ViewManager.newWindow("DeviceTreeView.fxml");
        treeController.setParentController(this);
    }
