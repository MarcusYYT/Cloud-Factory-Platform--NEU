...
public class UserManager {
    ...
    private LinkStack linkStack1 = new LinkStack();
    ...
    public boolean addRetailer(Retailer retailer) {
        ...
        FileOperator.removeFile("Retailers.json");
        while(!linkStack.isEmpty()){
            FileOperator.writeData(linkStack.pop(), "Retailers.json");
        }
        return true;
    }
    ...
    public boolean addFactoryAdmin(FactoryAdmin factoryAdmin) {
        ...
        FileOperator.removeFile("FactoryAdmins.json");
        while(!linkStack1.isEmpty()){
            FileOperator.writeData(linkStack1.pop(), "FactoryAdmins.json");
        }
        return true;
    }
    ...
    public List<FactoryAdmin> getFactoryAdmins() {
        return factoryAdmins = FileOperator.loadData("FactoryAdmins.json", FactoryAdmin.class);
    }
