 ...
 */
public class Sort {
    public static void selectSort(List<Order> list) {
        if (list.size() == 0) {
            return;
        }
        for (int i = 0; i < list.size(); i++) {
            ...
            for (int j = i + 1; j < list.size(); j++) {
                if (list.get(j).getSortIndex1() < list.get(i).getSortIndex1()) {
                    min = j;
                } else if (list.get(j).getSortIndex1() == list.get(i).getSortIndex1()) {
                    if (list.get(j).getSortIndex2() < list.get(i).getSortIndex2()) {
                        min = j;
                    } else if (list.get(j).getSortIndex2() == list.get(i).getSortIndex2()) {
                        if (list.get(j).getSortIndex3() < list.get(i).getSortIndex3()) {
                            min = j;
                        }
                    }
                }
    ...
    public static void main(String[] args) {
        ...
        brr = quickSort(arr, 0, arr.length-1);
        System.out.println(Arrays.toString(brr));
